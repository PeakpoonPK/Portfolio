...
const skills = [
    ...
    // { name: "Prisma", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/prisma/prisma-original.svg", invert: true }, // Verify usage
                ...
                <div className="flex overflow-hidden relative w-full group">
                    ...
                    >
                        {[...allSkills, ...allSkills].map((skill, index) => (
                            <div key={index} className="flex flex-col items-center justify-center space-y-4 group/item min-w-[100px] select-none">
                                <div className="w-16 h-16 md:w-20 md:h-20 bg-white/5 rounded-2xl flex items-center justify-center p-4 border border-white/10 group-hover/item:border-brand-primary/50 group-hover/item:bg-white/10 transition-all duration-300 backdrop-blur-sm">
                                    {skill.icon ? (
                                        ...
                                        <span className="text-xl font-bold text-white/40 group-hover/item:text-brand-primary transition-colors">
